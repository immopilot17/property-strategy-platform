  ...
  return (
    <div className="mx-auto min-h-[calc(100vh-72px)] max-w-[1600px] lg:grid lg:grid-cols-[236px_minmax(0,1fr)]">
      <aside className="border-b border-slate-200 bg-white px-4 py-3 dark:border-slate-800 dark:bg-slate-950 lg:border-b-0 lg:border-r lg:px-5 lg:py-8">
        <p className="mb-3 text-xs font-bold uppercase tracking-[0.14em] text-slate-400 lg:hidden">Wische für weitere Bereiche</p>
        <div className="relative">
          <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-5 bg-gradient-to-r from-white to-transparent dark:from-slate-950 lg:hidden" />
          <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-5 bg-gradient-to-l from-white to-transparent dark:from-slate-950 lg:hidden" />
